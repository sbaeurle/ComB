 ...
 * Changes: Simon Bäurle <simon.baeurle at tum.de>
 *
...
int main(int argc, char *argv[])
{
  ...
  str = g_strdup_printf("filesrc location=\"%s\" ! qtdemux name=demux demux.video_0! queue ! rtph264pay pt=96 name=pay0",
                        argv[1]);
  ...
  /* attach the factory to the corresponding url */
  gst_rtsp_mount_points_add_factory(mounts, g_strdup_printf("/%s", argv[1]), factory);
